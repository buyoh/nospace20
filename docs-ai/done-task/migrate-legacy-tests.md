...
- `__puti`, `__putc`, `__geti`, `__getc` などのI/Oビルトイン関数を使用 ✅ **実装済み**
- 一部は配列、ポインタなど未実装機能を使用

**方針**: 未実装機能（配列、ポインタ等）を使用するテストはコメントアウトで対応する。
...
- [docs-ai/spec/implementation-status.md](../spec/implementation-status.md) - 実装状況
