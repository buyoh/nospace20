...
- [docs-ai/done-task/block-scope-global-variables-implementation.md](../done-task/block-scope-global-variables-implementation.md) - 実装済みの変数機能
- [docs-ai/done-task/implement-multi-variable-declaration.md](../done-task/implement-multi-variable-declaration.md) - 実装済みの変数初期化機能
- [docs-ai/spec/implementation-status.md](../spec/implementation-status.md) - 実装状況の詳細
