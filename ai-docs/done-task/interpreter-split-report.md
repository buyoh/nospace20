...
- タスク仕様: [ai-docs/task/interpreter-split.md](interpreter-split.md)
- ユニットテスト計画: [ai-docs/task/unit-test-interpreter.md](../task/unit-test-interpreter.md)
- Suspendable interpreter: [ai-docs/task/suspendable-interpreter/](../task/suspendable-interpreter/)
