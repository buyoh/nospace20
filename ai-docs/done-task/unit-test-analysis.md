...
- [x] **T1-1**: token_parser のエラーケーステスト追加（5件程度） ✅ 完了
- [x] **T1-2**: token_parser の文字リテラル・エスケープシーケンステスト追加（5件程度） ✅ 完了
- [x] **T1-3**: logger のユニットテスト追加（3〜5件） ✅ 完了

**Phase 1 実施結果 (2026-02-01)**:
- token_parser に 12件の新規テスト追加（エラーケース 5件、文字リテラル・エスケープシーケンス 7件）
- logger に 4件の新規テスト追加
- TokenInfo 構造体に Debug トレイトを追加
- 全てのユニットテストが成功 (23 passed)
